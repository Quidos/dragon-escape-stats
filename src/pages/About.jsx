        ...
        <>
            ...
            <div className="pt-2 lg:pt-16 lg:pl-52">
                <div className="m-2 p-6 border bg-white">
                    ...
                    <p>Check out the project <a className="text-sky-700 hover:text-sky-900" href="https://github.com/Quidos/mpstats" target="_blank" rel="noopener noreferrer">here</a></p>
