const About = () => {
    return (
        <div className="pt-16 pl-52">
            ...
            <p>API by <a href="https://github.com/Timmi6790" target="_blank" rel="noopener noreferrer">Timmi6790</a></p>
            <p>Player avatars provided by <a href="https://crafatar.com" target="_blank" rel="noopener noreferrer">Crafatar</a></p>
            <p>Join the <a href="https://discord.gg/mKPJjea" target="_blank" rel="noopener noreferrer">discord</a></p>
        </div>
    )
}
